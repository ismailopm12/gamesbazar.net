-- Fix storage RLS policies to resolve image upload violations
-- This migration fixes the "new row violates row-level security policy" errors for all storage buckets
